...
class RecordsofconsumptionController extends Controller
{
    ...
    /**
     * Creates a new Recordsofconsumption model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new Recordsofconsumption();
    ...
    /**
     * Updates an existing Recordsofconsumption model.
    ...
    /**
     * Deletes an existing Recordsofconsumption model.
